  ...
  <div class="container">
    ...
    {#if !!partners.length}
      ...
      <button
        ...
        class="mt-14 flex gap-2 items-center transition-colors hover:text-accent text-white/90"
      >
        {#if !showMore}
          Показать еще
        {:else}

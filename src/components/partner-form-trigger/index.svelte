...
<Dialog.Root bind:open={dialogOpen}>
  <Dialog.Portal>
    ...
    <Dialog.Content
      transition={fade}
      class="bg-dark/90 fixed left-[50%] top-[50%] z-50 w-full max-w-[94%] translate-x-[-50%] translate-y-[-50%] border rounded-3xl px-5 py-7 outline-none sm:max-w-[490px] md:w-full"
    >
      <Dialog.Title asChild>
        <h2 class="font-sov-mod text-3xl uppercase">Оставь заявку</h2>
      </Dialog.Title>
